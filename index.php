	  ...
	  <div class="collapse navbar-collapse text-center" id="navbarsExample09">
			<ul class="navbar-nav mx-auto">
		  	...
		  	<ul class="list-inline mb-0 ml-lg-4 nav-social">
					<li class="list-inline-item"><a href="https://www.instagram.com/omar_ka03/"><i class="ti-instagram"></i></a></li>
					<li class="list-inline-item"><a href="https://github.com/OmarKandil-dw"><i class="ti-github"></i></a></li>
					<li class="list-inline-item"><a href="https://www.linkedin.com/in/omar-kandil-a80372233/"><i class="ti-linkedin"></i></a></li>
				</ul>
	  </div>
	</div>
</nav>
		...
		<div class="row align-items-center">
			...
			<div class="col-lg-6 col-12 col-md-7">
				<div class="ml-5 position-relative mt-5 mt-lg-0">
					<span class="head-trans">Omar</span>
					<h2 class="mt-3 text-lg mb-3 text-capitalize">Omar kandil</h2>
					<p class="animated fadeInUp lead mt-4 mb-5 text-white-50 lh-35">I am passionate about creating quality websites that improve the lives of those around me. I specialize in building websites for clients ranging from individuals and small businesses to large corporations.</p>
		...
		<div class="row">
			<div class="col-lg-6 col-md-6">
				<div class="row">
					...
					<div class="col-lg-8">
						<p class="text-white-50 text-md">Hello! I’m <span class="text-white">Kandil Omar </span>,an award winning web</span> with a <span class="text-white">proven track</span> record </p>
				...
				<div class="skill-bar mb-4 mb-lg-0">
					...
					<div class="progress">
						<div class="progress-bar" data-percent="50">
							<span class="percent-text"><span class="count">50</span>%</span>
						</div>
					</div>
				</div>
			</div>
...
<section class="section" id="portfolio" data-aos="fade-up">
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-lg-8">
				<div class="section-title text-center">
					<span class="text-color mb-0 text-uppercase letter-spacing text-sm"><i class="ti-minus mr-2"></i>Project</span>
					...
					<div class="testimonial-item position-relative">
						...
						<div class="testimonial-content">
							...
							<div class="media mt-5 align-items-center">
								...
								<div class="media-body">
									<h3 class="mb-0">Khalid el hadad</h3>
...
<footer class="footer border-top-1">
	<div class="container">
		<div class="row align-items-center text-center text-lg-left">
			...
			<div class="col-lg-5">
				<p class="lead"><span class="text-color">Omar kandil</span> © 2022 All Right Reserved.</p>
